...
export default function RoomFilter({ rooms }) {
    ...
    const {
        handleChange, type, capapcity, price, minPrice, maxPrice, minSize, maxSize, breakfast, pets
    } = Context
    //get unique types
        ...
        <section className="filter-container">
            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    ...
                    <select name="capacity" id="capacity" value={capapcity} className="form-control" onChange={handleChange}>
                        {people}
                    </select>
                </div>
                {/* end guests */}
